import Towing_service from "../models/towing_service.model.js";
import mongoose from "mongoose";

export const getTowing_services = async (req,res) => {
    try{
...
export const createTowing_service = async (req,res) => {
...
export const updateTowing_service =  async (req,res) => {
    const {id} = req.params;
...
export const deleteTowing_service = async (req,res) => {
    const {id} = req.params;
